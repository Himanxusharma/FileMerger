...
public class FileUploadController {
	...
	public String fileupload(@RequestParam("file1") MultipartFile file1, @RequestParam("file2") MultipartFile file2,
		...
		// Assuming the user provides the merge column index (0-based) as
		// mergeColumnIndex
